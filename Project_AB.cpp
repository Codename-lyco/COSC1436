...
int main() {
    ...
    do {
        ...
        int room_type;
        cout << endl << "Choose room type:" << endl;
        ...
        for (int i = 0; i < MAX_ROOMS; i++) {
            cout << setw(11) << (i + 101);  // Set width to 7 for room numbers
        }
        cout << endl;
        ...
        for (int index = 0; index < MAX_ROOMS; index++) {
            if (occupied[index] == 1)
                cout << setw(11) << "Taken";  // Set width to 10 for "Taken"
            else
                cout << setw(11) << "Available";  // Set width to 10 for "Available"
        }
        cout << endl << endl;
...
void signIn(const string &filename) {
    ...
    if (validateUser(filename, username, password)) {
        ...
        while(!validateUser(filename, username, password))
        {
